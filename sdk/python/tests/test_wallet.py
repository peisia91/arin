...
class TestWallet(unittest.IsolatedAsyncioTestCase):
    ...
    #
    #     self.assertEqual(account.receive_address[:5], "arin")
    ...
    #     self.assertEqual(account.receive_address, "arin:qpf5v0na3tygxpfgr3ej2rzje7qflwnnlfa4exe5vjhx7kedcfljwrtcvze7j")
    ...
    #     print("fee", fee)
    #
    #     result = await account.send("arin:qpwx6a66j38gqgxcvc74ts77fkxhdzdunl6uhvdcplp0cgvvwrx86n2zl67u0", 0.1, 0.2)
    ...
    #     account = await wallet.import_account("salute breeze kangaroo sword candy grass zero tent beef happy nice embrace devote venture swift wasp game horror obvious deputy same deny cushion clap")
    #
    #     self.assertEqual(account.change_address(), "arin:qz75jx7g5kg7ceaml22e6sv07y4yafeesrl2mchs8sadg644d0shghguyy8yq")
    ...
    async def testasd(self):
        ...
        # arin.call_with_callback(my_callback, {"key": "value"})
        ...
        # await account.send("arin:qq5ckhmt8l3qt96sm2wpcnewv0ezkr09677w6kpe32u5ds4ztjpl7q4qks6uk", 0.1, 0.2)
