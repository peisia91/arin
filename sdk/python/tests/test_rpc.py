...
class TestWallet(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_submit_block(self):
        ...
        result = await rpc.get_block_template("karin:qzn54t6vpasykvudztupcpwn2gelxf8y9p84szksr73me39mzf69uaalnymtx", [])
    ...
    async def test_get_balances_by_addresses(self):
        rpc = karin.RPC()
        await rpc.connect()
        balances = await rpc.get_balances_by_addresses(["karin:qzn54t6vpasykvudztupcpwn2gelxf8y9p84szksr73me39mzf69uaalnymtx"])
    ...
    async def test_get_utxos_by_addresses(self):
        rpc = karin.RPC()
        await rpc.connect()
        utxos = await rpc.get_utxos_by_addresses(["karin:qzn54t6vpasykvudztupcpwn2gelxf8y9p84szksr73me39mzf69uaalnymtx"])
    ...
    async def test_notifier(self):
        ...
        await rpc.on_utxos_changed(on_utxos_changed, ["karin:qqd9p8w75xqe80fx05qs0v3g0fmplztxays0f8x9l0asnn0apanlu9dd79gev"])
