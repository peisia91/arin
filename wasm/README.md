...
[<img alt="github" src="https://img.shields.io/badge/github-kaspanet/rusty--kaspa-8da0cb?style=for-the-badge&labelColor=555555&color=8da0cb&logo=github" height="20">](https://github.com/peisia91/arin/tree/master/wasm)
...
Arin WASM32 bindings offer direct integration of Rust code and Arin
...
follow instructions in the [Rusty Kaspa README](https://github.com/peisia91/arin).
...
`arin/wasm` if building from source). This is because examples use relative paths.
