...
(async () => {
    ...
    const mnemonic = new Mnemonic("hunt bitter praise lift buyer topic crane leopard uniform network inquiry over grain pass match crush mkarine strike doll relax fortune trumpet sunny silk")
